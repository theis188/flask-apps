...
// this is already built into js, why re-implement?
...
var monthList = [
  new month("January", 31, "Jan"),
  new month("February", 28, "Feb"),
  new month("March", 31, "Mar"),
  new month("April", 30, "Apr"),
  new month("May", 31, "May"),
  new month("June", 30, "Jun"),
  new month("July", 31, "Jul"),
  new month("August", 31, "Aug"),
  new month("September", 30, "Sep"),
  new month("October", 31, "Oct"),
  new month("November", 30, "Nov"),
  new month("December", 31, "Dec")
];
...
function calcAzElCustom(T, localtime, latitude, longitude, zone)
{
  var eqTime = calcEquationOfTime(T)
  var theta  = calcSunDeclination(T)
...
// Atmospheric Refraction correction
 ...
 var Az_Value = Math.floor(azimuth*100 +0.5)/100.0;
 var El_Value = Math.floor((90.0-solarZen)*100+0.5)/100.0;
 var AzEl = [Az_Value, El_Value];
